  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl font-bold text-slate-800 dark:text-slate-200 mb-3">About Campus Sync</h1>
        <p className="text-lg text-slate-500 dark:text-slate-400 max-w-2xl mx-auto">
          Your all-in-one college companion for managing schedules, events, notices, and society activities.
        </p>
      </div>

      <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-8 sm:p-12 shadow-sm mb-8">
        <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-200 mb-6">Our Story</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
          <div className="w-12 h-12 rounded-xl bg-teal-100 dark:bg-teal-900/40 flex items-center justify-center mb-4">
            <Target className="w-6 h-6 text-teal-600 dark:text-teal-400" />
          </div>
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Our Mission</h3>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
          ...
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">For Everyone</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 shadow-sm">
          ...
          <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-2">Smart Detection</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
